...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 15), // int()(double *, double *, void(*)(double *, double *), double *, double *, double *, double *, int *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 14), // double *
/*  2 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  3 */ _CFFI_OP(_CFFI_OP_POINTER, 10), // void(*)(double *, double *)
/*  4 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  5 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  6 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  7 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  8 */ _CFFI_OP(_CFFI_OP_POINTER, 15), // int *
/*  9 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 10 */ _CFFI_OP(_CFFI_OP_FUNCTION, 16), // void()(double *, double *)
...
static struct _cffi_externpy_s _cffi_externpy__fun =
  { "_pijavski.fun", 0, 0, 0 };

static void fun(double * a0, double * a1)
{
  char a[16];
  char *p = a;
  *(double * *)(p + 0) = a0;
  *(double * *)(p + 8) = a1;
  _cffi_call_python(&_cffi_externpy__fun, p);
}

static int _cffi_d_Pijavski(double * x0, double * x1, void(* x2)(double *, double *), double * x3, double * x4, double * x5, double * x6, int * x7)
{
  return Pijavski(x0, x1, x2, x3, x4, x5, x6, x7);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_Pijavski(PyObject *self, PyObject *args)
{
  double * x0;
  double * x1;
  ...
  if (!PyArg_UnpackTuple(args, "Pijavski", 8, 8, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7))
    return NULL;
  ...
  x2 = (void(*)(double *, double *))_cffi_to_c_pointer(arg2, _cffi_type(3));
  if (x2 == (void(*)(double *, double *))NULL && PyErr_Occurred())
    return NULL;
  ...
  _cffi_restore_errno();
  { result = Pijavski(x0, x1, x2, x3, x4, x5, x6, x7); }
  _cffi_save_errno();
...
#else
#  define _cffi_f_Pijavski _cffi_d_Pijavski
#endif

static void _cffi_d_fun(double * x0, double * x1)
{
  fun(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_fun(PyObject *self, PyObject *args)
{
  double * x0;
  double * x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "fun", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_fun _cffi_d_fun
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "Pijavski", (void *)_cffi_f_Pijavski, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_Pijavski },
  { "fun", (void *)&_cffi_externpy__fun, _CFFI_OP(_CFFI_OP_EXTERN_PYTHON, 3), (void *)fun },
  { "fun", (void *)_cffi_f_fun, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 10), (void *)_cffi_d_fun },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__pijavski(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__pijavski(void) { return NULL; }
#  else
     init_pijavski(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__pijavski(void)
{
  return _cffi_init("_pijavski", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_pijavski(void)
{
  _cffi_init("_pijavski", 0x2601, &_cffi_type_context);
}
#endif
